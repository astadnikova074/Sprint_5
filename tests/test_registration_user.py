...
def test_registration_user_opened_homepage(driver, random_email, test_password = 'Test1234'):
...
def test_registration_user_with_invalid_email_shows_error(driver, email):
    new_email = email
...
def test_registration_with_existing_email_shows_error(driver, random_email, test_password = 'Test1234'):

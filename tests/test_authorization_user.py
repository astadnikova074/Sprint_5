...
class TestAuthorization:
    #Login пользователя
    def test_login_success_shows_homepage(self, driver, random_email, test_password = 'Test1234'):
    #Перейти на стенд
        driver.get(URL)
    ...
    #Logout пользователя
    def  test_logout_hides_user_info(self, driver, random_email, test_password = 'Test1234'):
    #Перейти на стенд
        driver.get(URL)
        WebDriverWait(driver, 5).until(expected_conditions.visibility_of_element_located(LOGIN_AND_REGISTRATION_BUTTON))
